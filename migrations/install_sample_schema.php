			...
			'add_tables'		=> array(
				$this->table_prefix . 'minty_sl_seeds'	=> array(
					'COLUMNS'		=> array(
						...
						'flowering_time_days'	=> array('USINT', 0),
						'harvest_outdoors'		=> array('VCHAR_UNI:3', ''),
						'thc_percentage'		=> array('DECIMAL', 0),
						'cbd_percentage'		=> array('DECIMAL', 0),
						'indica_percentage'		=> array('DECIMAL', 0),
						'sativa_percentage'		=> array('DECIMAL', 0),
						'ruderalis_percentage'	=> array('DECIMAL', 0),
						'yeild_indoors_grams'	=> array('USINT', 0),
						'yeild_outdoors_grams'	=> array('USINT', 0),
						'height_indoors_mm'		=> array('USINT', 0),
						'height_outdoors_mm'	=> array('USINT', 0),
	...
	public function revert_schema()
	{
		return array(
			...
			'drop_tables'		=> array(
				...
				$this->table_prefix . 'minty_sl_breeders',
